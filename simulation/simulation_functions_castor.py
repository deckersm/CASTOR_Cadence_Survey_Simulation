...
def process_single_redshift(i, type, models, redshift_array, ra_array, dec_array, time_array, plateau, cadence, exposure, MyTelescope, MyBackground):
    z = redshift_array[i]
...
def populate_redshift_range(type, models, max_z, MyTelescope, MyBackground, plateau, min_z = 0, c_ra=9.45, c_dec=-44.0, radius=1.75, cadence = 1.0, exposure = 100, survey_time = 365.25, start_time = 0, test = False):
    ...
    for number in remaining_numbers:
        try:
            ...
            result = process_single_redshift(number, type, models, redshift_array, ra_array, dec_array, time_array,plateau, cadence, exposure, MyTelescope, MyBackground)
